...
export function makeConfig(overrides: Partial<Config> = {}): Config {
  const cfg: Config = {
    ...
    llama: { host: "127.0.0.1", port: 8000, bin: "/opt/llama/llama-server", contextSize: 32768 },
    model: { name: "Qwen2.5-Coder-3B-Instruct", file: "current.gguf", hostDir: "/opt/qwen-model", containerDir: "/models", containerPath: "/models/current.gguf" },
